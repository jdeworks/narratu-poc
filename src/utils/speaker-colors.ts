...
const PALETTE: PaletteEntry[] = [
  ...
  { bg: "rgba(251, 146, 60, 0.12)", border: "rgb(251, 146, 60)", textDark: "rgb(253, 186, 116)", textLight: "rgb(154, 52, 18)", hue: 27 },      // orange — orange-800 #9a3412 ≥4.5:1 on 12%-tinted panel bg
  ...
  { bg: "rgba(250, 204, 21, 0.12)", border: "rgb(250, 204, 21)", textDark: "rgb(253, 224, 71)", textLight: "rgb(133, 77, 14)", hue: 48 },        // yellow — yellow-800 #854d0e ≥4.5:1 on 12%-tinted panel bg
  ...
  { bg: "rgba(163, 230, 53, 0.12)", border: "rgb(163, 230, 53)", textDark: "rgb(190, 242, 100)", textLight: "rgb(63, 98, 18)", hue: 83 },      // lime — lime-800 #3f6212 ≥4.5:1 on 12%-tinted panel bg
  { bg: "rgba(99, 102, 241, 0.12)", border: "rgb(99, 102, 241)", textDark: "rgb(165, 180, 252)", textLight: "rgb(67, 56, 202)", hue: 239 },     // indigo
  { bg: "rgba(251, 191, 36, 0.12)", border: "rgb(251, 191, 36)", textDark: "rgb(252, 211, 77)", textLight: "rgb(146, 64, 14)", hue: 43 },        // amber — amber-800 #92400e ≥4.5:1 on 12%-tinted panel bg
